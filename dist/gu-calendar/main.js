...
var CalendarComponent = /** @class */ (function () {
    ...
    CalendarComponent.prototype.isEventForDate = function (date) {
        for (var i = 0; i < this.events.length; i++) {
            var obj = this.events[i];
            if (obj.day == date) {
                return true;
    ...
    CalendarComponent.prototype.getCalendarEvents = function () {
        ...
        this.calendarService.getAllEvents()
            .then(function (res) {
            _this.events = res;
            _this.dateSelected(new Date().getDate());
        }, function (err) {
            console.log(err);
        });
    };
